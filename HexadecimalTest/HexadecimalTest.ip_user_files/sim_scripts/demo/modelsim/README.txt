...
#
# Generated by export_simulation on Fri Dec 03 18:41:31 +0100 2021
#
################################################################################
...
'-reset_run' switch to the './demo.sh' script.
...
./demo.sh -noclean_files

For more information on the script, please type './demo.sh -help'.
