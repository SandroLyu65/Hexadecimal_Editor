...
(* CORE_GENERATION_INFO = "demo,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=demo,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=9,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=8,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "demo.hwdef" *) 
module demo
   (iClear,
    iClk,
    iDisplay,
    ...
    oVS);
  input iClear;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ICLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ICLK, CLK_DOMAIN demo_clk_in1_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input iClk;
  input iDisplay;
  input iInc;
  input iRst;
  input iSw0;
  ...
  wire [9:0]ScreenBufferMem_0_oCursorAddr;
  ...
  wire [9:0]number_capture_4bit_0_oCursorAddr;
  ...
  demo_Debounce_Switch_2_0 Debounce_Switch_2
       (.i_Clk(clk_wiz_0_clk_out1),
  ...
  demo_number_capture_4bit_0_0 number_capture_4bit_0
       (.iClear(Debounce_Switch_2_o_Switch),
        ...
        .oCursorAddr(number_capture_4bit_0_oCursorAddr),
