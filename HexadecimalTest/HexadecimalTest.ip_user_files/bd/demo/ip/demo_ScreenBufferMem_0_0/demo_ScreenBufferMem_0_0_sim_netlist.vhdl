...
-- Date        : Fri Dec  3 18:41:20 2021
-- Host        : DESKTOP-VFM2P2T running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/dell/Desktop/DDC/HexadecimalEditor/HexadecimalEditor.srcs/sources_1/bd/demo/ip/demo_ScreenBufferMem_0_0/demo_ScreenBufferMem_0_0_sim_netlist.vhdl
...
entity demo_ScreenBufferMem_0_0_ScreenBufferMem is
  port (
  ...
  attribute ORIG_REF_NAME of demo_ScreenBufferMem_0_0_ScreenBufferMem : entity is "ScreenBufferMem";
end demo_ScreenBufferMem_0_0_ScreenBufferMem;

architecture STRUCTURE of demo_ScreenBufferMem_0_0_ScreenBufferMem is
...
begin
\rCursorAddr_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => iClk,
      CE => iWeB,
      D => iCursorAddr(0),
...
\rCursorAddr_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => iClk,
      CE => iWeB,
      D => iCursorAddr(1),
...
\rCursorAddr_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => iClk,
      CE => iWeB,
      D => iCursorAddr(2),
...
\rCursorAddr_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => iClk,
      CE => iWeB,
      D => iCursorAddr(3),
...
\rCursorAddr_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => iClk,
      CE => iWeB,
      D => iCursorAddr(4),
...
\rCursorAddr_reg[5]\: unisim.vcomponents.FDRE
     port map (
      C => iClk,
      CE => iWeB,
      D => iCursorAddr(5),
...
\rCursorAddr_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => iClk,
      CE => iWeB,
      D => iCursorAddr(6),
...
\rCursorAddr_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => iClk,
      CE => iWeB,
      D => iCursorAddr(7),
...
\rCursorAddr_reg[8]\: unisim.vcomponents.FDRE
     port map (
      C => iClk,
      CE => iWeB,
      D => iCursorAddr(8),
...
\rCursorAddr_reg[9]\: unisim.vcomponents.FDRE
     port map (
      C => iClk,
      CE => iWeB,
      D => iCursorAddr(9),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity demo_ScreenBufferMem_0_0 is
  port (
    iClk : in STD_LOGIC;
    iAddrA : in STD_LOGIC_VECTOR ( 9 downto 0 );
    iAddrB : in STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  attribute NotValidForBitStream of demo_ScreenBufferMem_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of demo_ScreenBufferMem_0_0 : entity is "demo_ScreenBufferMem_0_0,ScreenBufferMem,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of demo_ScreenBufferMem_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of demo_ScreenBufferMem_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of demo_ScreenBufferMem_0_0 : entity is "ScreenBufferMem,Vivado 2020.1";
end demo_ScreenBufferMem_0_0;

architecture STRUCTURE of demo_ScreenBufferMem_0_0 is
begin
inst: entity work.demo_ScreenBufferMem_0_0_ScreenBufferMem
     port map (
