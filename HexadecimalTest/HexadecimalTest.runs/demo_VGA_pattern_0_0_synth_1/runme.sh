...
HD_PWD='C:/Users/dell/Desktop/DDC/Lab5/Final_Project/HexadecimalTest/HexadecimalTest.runs/demo_VGA_pattern_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demo_VGA_pattern_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demo_VGA_pattern_0_0.tcl
