...
HD_PWD='C:/Users/dell/Desktop/DDC/HexadecimalEditor/HexadecimalEditor.runs/demo_AsciiCharsMem_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demo_AsciiCharsMem_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demo_AsciiCharsMem_0_0.tcl
