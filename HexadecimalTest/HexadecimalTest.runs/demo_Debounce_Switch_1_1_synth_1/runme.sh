...
HD_PWD='C:/Users/dell/Desktop/DDC/Lab5/Final_Project/HexadecimalTest/HexadecimalTest.runs/demo_Debounce_Switch_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demo_Debounce_Switch_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demo_Debounce_Switch_1_1.tcl
