...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "counterbits" -parent ${Page_0}
...
proc update_PARAM_VALUE.counterbits { PARAM_VALUE.counterbits } {
	# Procedure called to update counterbits when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.counterbits { PARAM_VALUE.counterbits } {
	# Procedure called to validate counterbits
	return true
}
...
proc update_MODELPARAM_VALUE.counterbits { MODELPARAM_VALUE.counterbits PARAM_VALUE.counterbits } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.counterbits}] ${MODELPARAM_VALUE.counterbits}
}
